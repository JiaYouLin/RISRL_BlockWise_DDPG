...
class Environment:
    ...
    def getDistMats(self) -> Tuple[torch.Tensor]:
        ...
        if (self.D_BS is None):
            ...
            # 確認BS是朝著-x方向打訊號
            # print(f"BS_pos: {self.BS_pos}")
            # print(f"RIS_pos: {self.ris_pos}")
            # print(f"cos_angle_in: {self.cos_angle_in}")
    ...
    def plot_block_cond(self, dir: str) -> None:
        ...
        # print(f'Saved: "{dir}/visi_cond_{self.scenario}.png"')            # 儲存場景圖片路徑
    ...
    def show(self, dir: str) -> None:
        ...
        ax.add_collection3d(copy.deepcopy(poly))  # [DEBUG] 因應DEBUG修正
        # ax.add_collection3d(poly)     # Xuan-Yi
        ...
        # print(f'Saved: "{dir}/preview_{self.scenario}.png"')        # 儲存場景圖片路徑
        plt.close(fig)  # [DEBUG] 因應DEBUG修正