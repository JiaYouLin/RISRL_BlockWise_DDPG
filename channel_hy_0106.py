...
class Channel(Environment):
    ...
    def get_channel_coefficient(self) -> Tuple[torch.Tensor, torch.Tensor]:
    ...
    def get_joint_channel_coefficient(
        ...
        if (self.H_BS is None) or (self.h_Sk is None) or (self.h_Bk is None):
            print("Run Channel.get_channel_coefficient() beforehand")
            exit()
...
if __name__ == "__main__":
    """
    執行指令: python channel_hy_0106.py -e "RIS2x2_UE1_1_rectangle1020_FullyBlocked"
    """
    ...
    # Test
    n_env = 16 # number of parallel environments
    h_ris = ris_size[0]
    w_ris = ris_size[1]
    ...
    for i in range(6):
        ...
        print("SINR:", 10*torch.log10(SINR), " dB")
